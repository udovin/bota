...
use crate::engine::{Entity, PriorityOrder, UnitOrder, World, class_rank_of};
use crate::sim::{isqrt64, rules};
...
impl World {
    ...
    /// into account.
    ///
    /// A neutral walking home takes nothing on. A creep just roused by an
